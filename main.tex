...
Modern sleep science is built upon the discovery that sleep is not a monolithic state of passive rest, but a highly structured, dynamic process. This process is broadly divided into two distinct states, Non-Rapid Eye Movement (NREM) sleep and Rapid Eye Movement (REM) sleep, which cycle throughout the night~\cite{fuller2006}.

\input{part2/sleep_architecture/nrem}
\input{part2/sleep_architecture/rem}
\input{part2/sleep_architecture/cycle}

\chapter{The Functions of Sleep: Far More than Rest}\label{ch:functions}
...
\input{part2/functions/maintenance_trio}
\input{part2/functions/consolidation}
\input{part2/functions/generalization}
...
\input{part2/phenomenology/hypnagogia}
\input{part2/phenomenology/nrem}
\input{part2/phenomenology/rem}
\input{part2/phenomenology/lucid}
...
\chapter{What fails when we remove sleep}\label{ch:what_fails}
